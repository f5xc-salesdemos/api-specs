...
make spectral-lint   # Modo descubrimiento de Spectral sobre las specs originales
make reconcile       # Aplicar correcciones de ambos informes
make spectral-gate   # Puerta de calidad de Spectral sobre las specs reconciliadas
...
```bash
make docs-generate   # Regenerar docs/01-validation-report.mdx desde los informes
make docs            # Construir el sitio de documentación completo
...
scripts/
  ...
  generate_docs.py      # Generar MDX desde los informes
  utils/
...
- **Despacho manual**: Con opciones para release forzado o dry-run

El flujo de trabajo tiene cuatro jobs:

1. **validate** -- Descarga specs, ejecuta validación, lint de Spectral, reconciliación, puerta de calidad de Spectral
